...
- 按 2028 届、资源与环境（085700）、测绘与遥感方向、党员、英语成绩和城市偏好评分。专业名称和代码采用精确匹配，不用子串匹配。
- 公务员、参公和选调生岗位同时按《江苏省2026年度考试录用公务员专业参考目录》判断专业大类；资源与环境（研究生）对应土地管理类、测绘类、地质矿产类、安全生产类、环境保护类。
...
- 本地职位表岗位展示官方发布页、原始文件、工作表、表格行号和职位代码，便于逐项回查。
...
“资源与环境经济学”“人口、资源与环境经济学”等名称不会命中“资源与环境（085700）”。研究方向中的“测绘”“遥感”也不会被当作毕业证专业，只作为待确认线索。事业单位等非公务员岗位若出现上述专业大类，只有在公告明确采用该目录时才能据此确认资格。
